    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <#--分页-->
                ...
                <#else>
                    <li>
                        <a href="/sell/seller/product/list?page=${pageInfo.getPageNum() - 1}&size=${pageInfo.getPageSize()}">上一页</a>
                    </li>
                </#if>
                ...
                <#list 1..pageInfo.getPages() as index>
                    ...
                    <#else>
                         <li><a href="/sell/seller/product/list?page=${index}&size=${pageInfo.getPageSize()}">${index}</a>
                         </li>
                    </#if>
                </#list>
                ...
                <#else>
                    <li>
                        <a href="/sell/seller/product/list?page=${pageInfo.getPageNum() + 1}&size=${pageInfo.getPageSize()}">下一页</a>
                    </li>
                </#if>
